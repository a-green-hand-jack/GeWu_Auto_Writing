#!/usr/bin/env bash
# Round 10: all 30 manuscripts, after the launcher prompt was re-audited against
# the rewritten skill (every section pointer checked, no stale vocabulary) and the
# per-task LKM call budget was raised to 150.
